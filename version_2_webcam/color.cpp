...
//	split(inputImage, rgb);
	double maxInt;
//	Mat retImage = (rgb[0] + rgb[1] + rgb[2])/3;

//imwrite("rgb0.jpg" , rgb[0]);
//imwrite("rgb1.jpg" , rgb[1]);
//imwrite("rgb2.jpg" , rgb[2]);
...
/*
imwrite("red_pyr[8].jpg" , red_pyr[2]);
imwrite("green_pyr[8].jpg" , green_pyr[2]);
imwrite("blue_pyr[8].jpg" , blue_pyr[2]);
imwrite("yellow_pyr[8].jpg" , yellow_pyr[2]);
*/
